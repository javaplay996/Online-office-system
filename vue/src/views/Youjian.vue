...
<!--      <el-input style="width: 200px" placeholder="请输入" suffix-icon="el-icon-position" class="ml-5" v-model="address"></el-input>-->
    ...
    <div style="margin: 10px 0">
      <el-button type="primary" @click="handleAdd">发送邮件 <i class="el-icon-circle-plus-outline"></i></el-button>
      <el-popconfirm
          class="ml-5"
      ...
      <!-- <el-upload action="http://localhost:9090/youjian/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">
    ...
    <el-table :data="tableData" border stripe :header-cell-class-name="'headerBg'"  @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="sendemail" label="发送邮件账号"></el-table-column>
      <el-table-column prop="receiveemail" label="接收邮件账号"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="40%" :close-on-click-modal="false">
      <el-form label-width="140px" size="small" style="width: 85%;" :model="form" :rules="rules" ref="ruleForm">
        ...
        <el-form-item prop="receiveemail" label="接收邮件账号">
          <el-input v-model="form.receiveemail" autocomplete="off"></el-input>
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    delBatch() {
      ...
      this.request.post("/youjian/del/batch", ids).then(res => {
        if (res.code === '200') {
    ...
    exp() {
      window.open("http://localhost:9090/youjian/export")
    },
